...
class Rule extends Model {
    ...
    public function classExists() {
        ...
        } else if (($ruleName = (new $this->className())->name) !== $this->name) {
            $message = 'The "{className}::'.$ruleName.'" is incorrect with the name of rule you have set';
        }

        if ($message !== null) {
            $this->addError('className', Module::t('module', $message, ['className' => $this->className]));
        }
    }
    ...
    public function attributeLabels() {
        return [
            'name' => Module::t('module', 'Rule Name'),
            'className' => Module::t('module', 'Class Name'),
        ];
    }
