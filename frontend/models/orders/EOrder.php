...
class EOrder extends \frontend\models\base\MyActiveRecord
{
    ...
    {
        return [
            [['type', 'status', 'ebay_id', 'user_id', 'ebay_order_id', 'ebay_seller_id', 'buyer_id', 'recipient_name', 'recipient_address1', 'recipient_city', 'recipient_state', 'recipient_postcode'], 'required'],
            [['type', 'status', 'ebay_id', 'user_id', 'sale_record_number'], 'integer'],
            [['fetched_at', 'created_time', 'paid_time', 'shipped_time'], 'safe'],
            [['total'], 'number'],
            [['ebay_order_id', 'ebay_seller_id', 'recipient_name', 'recipient_city', 'recipient_state', 'tracking_number'], 'string', 'max' => 64],
