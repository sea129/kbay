...
<div class="batch-product-form col-xs-12">
	<?php $form = ActiveForm::begin([
                ...
                'validationUrl' => Url::to(['product/validate-form','id'=>$model->id,'mainID'=>$mainID]),
                ]); ?>
    <!-- 每单数量 -->
    ...
    <div class="row col-sm-12 form-group">
    	<div class="col-sm-2 no-padding-right control-label">
    		<?= Html::encode(Yii::t('app/product', 'auto generate')); ?>
    	</div>
    	<div class="col-sm-10">
    		<label>
				<input class="ace ace-switch ace-switch-4 btn-flat" type="checkbox" id='auto-generate'>
				<span class="lbl"></span>
			</label>
    	</div>
    </div>
    ...
    <div class="form-group">
    	...
    	<div class="col-sm-6">
    		<h4>
    			<?php echo $model->category_id==null?'Not set':$model->getCategories()[$model->category_id]; ?>
			</h4>
    	</div>
    </div>
